...
public class AndroidDataStore extends SQLiteOpenHelper { //implements ClientDataStore<String>{

    public static final String DB_NAME = "sync.db";
    public static final int DB_VERSION = 1;
    public static final String TABLE = "documents";

    public static final String DOC_ID = BaseColumns._ID;
    public static final String CLIENT_ID = "clientId";
    public static final String CONTENT = "content";

    public AndroidDataStore(final Context context) {
        super(context, DB_NAME, null, DB_VERSION);
    }

    @Override
    public void onCreate(final SQLiteDatabase db) {
        final String sql = String.format("create table %s (%s int primary key, %s text)", TABLE, DOC_ID, CONTENT);
        db.execSQL(sql);
    }
